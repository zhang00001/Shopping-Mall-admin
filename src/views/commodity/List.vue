    ...
    <div class="top">
      ...
      <el-select v-model="warehouse_id" placeholder="请选择" clearable>
         <el-option
                      ...
                      ></el-option>
        <el-option v-for="item in warehouses" :key="item.id" :label="item.title" :value="item.id"></el-option>
      </el-select>
    </el-col>
     <el-col :span="6">
      <span>供货商</span>
      ...
      <el-select v-model="supplier_id" placeholder="请选择" clearable>
         <el-option
                      ...
                      ></el-option>
        <el-option v-for="item in suppliers" :key="item.id" :label="item.supplier" :value="item.id"></el-option>
      </el-select>
    </el-col>
         <el-col :span="6">
...
data={
  id: this.multipleSelection.map(val => val.id).toString(),
    ...
    // 加载列表
    getList(page,title,classify_id,type,brand_id,shelf,warehouse_id,supplier_id) {
      http
