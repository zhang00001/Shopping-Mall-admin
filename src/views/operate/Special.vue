    ...
    <template>
      ...
      >
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
             <el-button @click="editGood(scope.row)" type="text" size="small">关联商品</el-button>
...
import {special_more ,goods_class_more,special_one,special_manage,special_del,special_goods_join} from "@/api/index"
...
if(goods.length>0){
  special_goods_join({special_id:this.selectId,goods_id:goods.toString()}).then(res=>{
   if(res.code==200){
